...
package org.nebula.service.exception;
...
@ControllerAdvice
public class NebulaExceptionHandler extends ResponseEntityExceptionHandler {

  private final static Logger logger = Logger.getLogger(NebulaExceptionHandler.class);
