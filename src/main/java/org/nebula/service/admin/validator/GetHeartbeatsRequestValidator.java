...
@Component
public class GetHeartbeatsRequestValidator extends
                                           AbstractValidator<GetHeartbeatsRequest> {

  @Override
  protected void verify(GetHeartbeatsRequest request) {

    Validate.notNull(request,
                     "The getHeartbeats request should not be null.");
  ...
  @Override
  protected void verifyAuthorization(GetHeartbeatsRequest request){
