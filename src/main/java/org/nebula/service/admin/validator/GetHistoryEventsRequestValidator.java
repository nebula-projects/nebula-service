...
@Component
public class GetHistoryEventsRequestValidator extends AbstractValidator<GetHistoryEventsRequest> {

  @Override
  protected void verify(GetHistoryEventsRequest request) {

    Validate.notNull(request,
                     "The getHistoryEvents request should not be null.");
  ...
  @Override
  protected void verifyAuthorization(GetHistoryEventsRequest request){
