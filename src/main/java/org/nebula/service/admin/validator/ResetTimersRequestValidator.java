...
@Component
public class ResetTimersRequestValidator extends
                                         AbstractValidator<ResetTimersRequest> {

  @Override
  protected void verify(ResetTimersRequest request) {

    Validate.notNull(request,
                     "The ResetTimersRequest should not be null.");

    Validate.notEmpty(request.getRegistrationId(),
                      "The registrationId should be empty.");

  }

  @Override
  protected void verifyAuthorization(ResetTimersRequest request){
    Validate.isTrue(request.getAccessId().equals(request.getRegistrationId()),
