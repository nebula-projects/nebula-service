...
@Component
public class GetRegistrationRequestValidator extends
                                             AbstractValidator<GetRegistrationRequest> {

  @Override
  protected void verify(GetRegistrationRequest request) {

    Validate.notNull(request,
                     "The getRegistration request should not be null.");

    Validate.notEmpty(request.getId(),
                      "The id should not be empty.");
  }

  @Override
  protected void verifyAuthorization(GetRegistrationRequest request){
    Validate.isTrue(request.getAccessId().equals(IdUtils.extractAccessId(request.getId())),
