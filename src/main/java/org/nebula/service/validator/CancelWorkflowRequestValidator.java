...
@Component
public class CancelWorkflowRequestValidator extends
                                            AbstractValidator<CancelWorkflowRequest> {

  @Override
  protected void verify(CancelWorkflowRequest request) {

    Validate.notNull(request,
                     "The cancelWorkflow request should not be null.");

    Validate.notEmpty(request.getInstanceId(),
                      "The instance id should not be empty.");

    Validate.notEmpty(request.getRealms(), "The realms should not be empty.");

  }

  @Override
  protected void verifyAuthorization(CancelWorkflowRequest request){
    Validate.isTrue(
